...
const DICT: Record<Lang, Record<string, string>> = {
  th: {
    ...
    noOverdueJobs: 'ไม่มีงานเลยกำหนด', noPendingJobs: 'ไม่มีงานรออนุมัติ',
    ...
    pageFirst: 'หน้าแรก', pagePrev: 'ย้อนกลับ', pageLast: 'หน้าสุดท้าย',
    ...
    province: 'จังหวัด', colProvince: 'จังหวัด', selectProvince: 'เลือกจังหวัด',
    region: 'เขต', regionAuto: 'กำหนดอัตโนมัติตามจังหวัด',
    ...
    scopeAssigned: 'จากงานที่ได้รับทั้งหมด', scopeCompleted: 'จากงานที่เสร็จสิ้น', scopeCancelled: 'จากงานที่ยกเลิกแล้ว',
  ...
  en: {
    ...
    noOverdueJobs: 'No overdue jobs', noPendingJobs: 'No jobs pending approval',
    ...
    pageFirst: 'First page', pagePrev: 'Previous', pageLast: 'Last page',
    ...
    province: 'Province', colProvince: 'Province', selectProvince: 'Select province',
    region: 'Region', regionAuto: 'Set automatically from province',
    ...
    scopeAssigned: 'from all assigned jobs', scopeCompleted: 'from completed jobs', scopeCancelled: 'from cancelled jobs',
